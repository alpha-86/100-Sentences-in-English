...
<div class="howto">
  ...
  <h2>这本书怎么用</h2>
  <p>每天学 1 句，从 Day 1 学到 Day 60，每天大约 15-20 分钟。学习步骤：</p>
  <ul>
    <li>第 1 步：看着英文句，大声朗读 3 遍；</li>
    <li>第 2 步：看中文意思，确认自己读懂了；</li>
    <li>第 3 步：读「语法 · 句型」讲解，明白这句话为什么这样说；</li>
    <li>第 4 步：记 7 个生词和 1-3 个短语；</li>
    <li>第 5 步（最重要）：<b>背诵</b>——合上书，把整句背出来；<b>背写</b>——不看卡片，把整句默写在本子上，写错的地方用红笔改 3 遍。</li>
  </ul>

  <h2>每天回读（艾宾浩斯遗忘曲线）</h2>
  <p class="blue">每张卡片底部有一条蓝色的「今日回读」，写着今天要重新朗读背诵的旧句子。它按照艾宾浩斯遗忘曲线设计：学完一句后，在第 1、2、4、7、15、30 天各复习一次，每句话一共复习 6 次。回读的要求和新学一样：先朗读，再<b>背诵</b>，有时间就<b>背写</b>一遍。</p>
  ...
  <ul>
    ...
    <li>今日回读：蓝色条，今天需要重新朗读、背诵（最好背写）的旧句子；</li>
  ...
  <ul>
    ...
    <li>背诵和背写是每天的关键：先合上书背出来，再默写一遍，写错的词重点练；</li>
    <li>不要赶进度，一天一句就好；某天状态不好，只做「今日回读」也可以；</li>
    <li>鼓励孩子把句子演出来：学问候句就和家人打招呼，学生日句就给家人唱数蜡烛。</li>
  </ul>

  <h2>给小朋友的话</h2>
  <p class="hl">每天一句，读出来、背下来、写一遍，跟着「今日回读」复习，60 天后你就会背会写全部 420 个单词的 60 个句子——和 Harry 一起，从 Hogwarts 顺利毕业吧！</p>
</div>
"""
