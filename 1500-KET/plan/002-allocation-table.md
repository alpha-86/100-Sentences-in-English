<!-- 本文件由 scripts/allocate_words.py 生成，请勿手改；改 allocation/act*.py 后重跑 -->
...
扩展必背词 7 个：
- 序数 13-19（锚词：twelfth）：thirteenth、fourteenth、fifteenth、sixteenth、seventeenth、eighteenth、nineteenth

### Day 39｜第 4 幕｜序数收尾
句中新词 8 个：**twenty-first**、**twenty-fifth**、**thirty-first**、**about**、**almost**、**nearly**、**per**、**total**
扩展必背词 8 个：
- 大序数（锚词：twenty-first）：twenty-second、twenty-third、twenty-fourth、twenty-sixth、twenty-seventh、twenty-eighth、twenty-ninth、thirtieth
